...
public class CriteriosBusquedaPaciente {
    ...
    private static final Set<String> CAMPOS_ORDENAMIENTO_PERMITIDOS = Set.of(
            "numeroDocumento", "tipoDocumento", "nombre", "apellido", "correoElectronico", "fechaNacimiento", "telefono", "eps", "genero"
    );
    ...
    public CriteriosBusquedaPaciente(String nombre, String apellido, Integer edadMinima, Integer edadMaxima, int page,
